...
int flag_runner = -1; //0번은 라인 following /1번 Maze /2번 장애물 회피
/* 초음파 센서 + 라인센서로 판단 */
...
void loop()
{
  ...
  {
    obstacle_avoiddance();                  //임이로 넣음
    mission_flag[3] = 1;                    //임이로 넣음
