...
void line_follwing(int line_index)
{
  switch(line_index)
  {
    case -4: motor_R_control(-10); motor_L_control(120);
            break;
    case -3:motor_R_control(-30);motor_L_control(120);
            break;
    case -2:motor_R_control(-50);motor_L_control(110);
            break;
    case -1:motor_R_control(-70);motor_L_control(100);
            break;
    case  0: motor_R_control(100);motor_L_control(80);
            break;
    case  1:motor_R_control(100);motor_L_control(-70);
            break;
    case  2:motor_R_control(110);motor_L_control(-50);
            break;
    case  3:motor_R_control(120);motor_L_control(-30);
            break;
